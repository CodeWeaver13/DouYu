 ...
 **/
public class OtherVideoFragment extends BaseFragment<VideoCateListLogic, VideoCateListPresenterImpl> implements VideoAllCateListContract.View,ViewPager.OnPageChangeListener {
    /**
     *   导航栏 分页
     */
////    小圆点指示器
...
//    导航栏
    ...
    public static OtherVideoFragment getInstance(VideoCateList args, int position) {
        ...
        bundle.putString("type",args.getCate1_name());
